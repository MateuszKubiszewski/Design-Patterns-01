...
namespace TravelAgencies.Agencies
{
    class PolandTravel : ITravelAgency
    {
        ...
        Random random = new Random(21372137);

        public PolandTravel(BookingDatabase bookingDb, OysterDatabase oysterDb, ShutterStockDatabase shutterStockDb, TripAdvisorDatabase tripAdvisorDb)
        {
        ...
        public IReview CreateReview()
        {
            ...
            PolishReview plreview = new PolishReview();
            plreview.SetComponent(review);
            return plreview;
        }
        ...
        {       
            ...
            for (int i = 0; i < no; i++)
            {
                ...
                while (tripAdvisorData.Country != "Poland")
            ...
            PolishTrip pltrip = new PolishTrip();
            pltrip.SetComponent(trip);
            return pltrip;
        }
    }
}
